...
| **F5.3** | 足迹地图       | 在地图上可视化的展示用户日记足迹，支持按时间、地点、情感维度聚类查看过往记忆。                             | P1     | [无法正常显示] |
...
| ID       | 功能特性     | 描述                                                                                                           | 优先级 | 状态     |
| :------- | :----------- | :------------------------------------------------------------------------------------------------------------- | :----- | :------- |
| **F6.1** | 实体自动抽取 | AI 从日记中自动提取关键实体（人物、地点、事件、情绪、物品等），构建用户专属知识图谱。                          | P1     | [已完成] |
| **F6.2** | 关系图谱构建 | 基于实体间的共现和语义分析，自动推断并建立关系边（如：与某人的关系、事件的因果链）。                           | P1     | [已完成] |
| **F6.3** | 多跳推理问答 | AI 可回答复杂问题，如"我和小明是怎么认识的？后来发生了什么？"，通过图谱遍历进行多跳推理。                      | P1     | [已完成] |
| **F6.4** | 人生时间线   | 可视化展示用户人生重要节点的时间线，基于图谱自动聚类生成"人生章节"。                                           | P2     | [已完成] |
