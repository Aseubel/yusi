...
public class TokenServiceImpl implements TokenService {
    ...
    @Override
    public boolean rotateRefreshToken(String userId, String expectedToken, String replacementToken) {
        RLock lock = redissonClient.getLock(REFRESH_TOKEN_KEY + userId + ":lock");
        ...
        try {
            ...
            saveRefreshToken(userId, replacementToken);
            return true;
