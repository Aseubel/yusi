...
public final class AgentToolCapabilityConstants {

    public static final String VERSION_V1 = "v1";
    public static final String METADATA_VERSION = "yusi.agent.capability.version";
    public static final String METADATA_PERMISSION_SCOPES = "yusi.agent.capability.permission_scopes";
