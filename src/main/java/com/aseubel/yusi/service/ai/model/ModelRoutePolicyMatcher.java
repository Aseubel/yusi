...
public class ModelRoutePolicyMatcher {
    ...
    private RouteMatch score(RoutePolicyDefinition route, String scene) {
        ...
        return new RouteMatch(route, sceneSpecificity, sceneSpecificity);
    }
